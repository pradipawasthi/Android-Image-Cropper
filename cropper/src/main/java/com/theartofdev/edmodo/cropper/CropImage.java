...
//   */
    public static ActivityBuilder activity() {
        return new ActivityBuilder(null, null);
    }
...
//   * @return builder for Crop Image Activity
//   */
    public static ActivityBuilder activity(@Nullable Uri uri, String test) {
        return new ActivityBuilder(uri, test);
    }
    ...
    public static final class ActivityBuilder {
        ...
        private ActivityBuilder(@Nullable Uri source, String test) {
            mSource = source;
